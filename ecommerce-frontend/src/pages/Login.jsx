...
/**
 * Login Page
 * Beautiful, human-touch design for user authentication
 */
const Login = () => {
        ...
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
                <div className="w-full max-w-md">
                    ...
                    {/* Error Message */}
                    {errors.general && (
                        <div className="mb-6 p-4 bg-error/10 border border-error/20 rounded-xl text-error text-sm flex items-start gap-2">
            ...
            <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-primary-50 via-neutral-50 to-secondary-50 overflow-hidden">
