...
/**
 * Register Page
 * User registration with beautiful Velora design
 */
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-secondary-50 via-neutral-50 to-accent-50 overflow-hidden">
